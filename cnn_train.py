...
past = Conv1D(64, kernel_size=5, strides=1, padding='same', activation='relu')(past_in)
past = MaxPooling1D(2, padding='same')(past)
past = Dropout(0.5)(past)
past = Conv1D(64, kernel_size=5, strides=1, padding='same', activation='relu')(past)
past = MaxPooling1D(2, padding='same')(past)
past = Dropout(0.5)(past)
past = Conv1D(64, kernel_size=5, strides=1, padding='same', activation='relu')(past)
past = MaxPooling1D(2, padding='same')(past)
